...
export default function WishlistPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8 bg-background min-h-[60vh]">
      <h1 className="font-display text-3xl sm:text-4xl text-foreground">Saved trips</h1>
      {saved.length === 0 ? (
        <div className="mt-10 rounded-3xl border border-dashed border-border bg-card p-12 text-center">
          <span className="mx-auto grid size-20 place-items-center rounded-full bg-coral/15 text-coral">
            <Heart className="size-9" />
          </span>
          <h2 className="mt-6 font-display text-2xl text-foreground">Nothing saved yet</h2>
