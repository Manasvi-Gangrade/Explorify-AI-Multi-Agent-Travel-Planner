...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ExplorifyTrips — Handpicked India Tour Packages" },
      {
        name: "description",
        content:
          "Book handpicked Indian tours: Kashmir, Rajasthan, Kerala, Ladakh, Goa and more. Verified local operators, secure Razorpay payments.",
      },
      { name: "author", content: "ExplorifyTrips" },
      { property: "og:site_name", content: "ExplorifyTrips" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          name: "ExplorifyTrips",
          description:
            "Indian tours and travel booking platform offering handpicked journeys across India.",
          address: {
            "@type": "PostalAddress",
